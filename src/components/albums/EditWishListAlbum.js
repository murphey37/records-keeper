...
export const EditWishListAlbum = () => {
    /*
...
const {id}=useParams()
    ...
    */
    ...
    useEffect(
        () => {
            fetch(`https://vast-eyrie-36954.herokuapp.com/albums/${id}`)
        ...
        [id] // When this array is empty, you are observing initial component state
    )
    ...
    const handleSaveButtonClick = (event) => {
        ...
        return fetch(`https://vast-eyrie-36954.herokuapp.com/albums/${album.id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <form className="albumForm">
            <h2 className="albumForm__title">Edit Album</h2>
            <fieldset>
